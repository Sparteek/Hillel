...
#     with open("login_system.log") as file_log:
#         logs = file_log.read()
...
#     with open("login_system.log") as file_log:
#         logs = file_log.read()
#     message = get_message("user2", "expired")
#     assert message in logs
#
...
#     with open("login_system.log") as file_log:
#         logs = file_log.read()
#         message = get_message("user3", "failed")
#         assert message in logs
...
def test_log_event_failed():
    ...
    # #test expired status
    # log_event("use2", "expired")
    # #Test failed status
    # log_event("use3", "failed")
    #
    # with open("login_system.log", "r") as file_log:
    #      logs = file_log.read()
    #
    # message = get_message("user1", "success")
    #
